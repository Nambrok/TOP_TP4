...
void somme(int_bmp_pixel_t * res, int_bmp_pixel_t * tab, int i, int j, int height, int width, enum couleur col){
        ...
        case Rouge:
                ...
                res[i * width + j].Bleu = tab[i * width + j].Bleu;
                res[i * width + j].Vert = tab[i * width + j].Vert;
                break;
        case Bleu:
                res[i * width + j].Rouge = tab[i * width + j].Rouge;
...
void sommeFantome(int_bmp_pixel_t * res, int_bmp_pixel_t * tab, int i, int j, int height, int width, int_bmp_pixel_t * fantomeHaut, int_bmp_pixel_t * fantomeBas, enum couleur col){
        double resRed = 0;
        double resBlue = 0;
        double resGreen = 0;
        int nombreCases = 0;
